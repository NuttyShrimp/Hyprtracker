...
std::chrono::time_point<std::chrono::system_clock> switch_time = std::chrono::system_clock::now();
...
void handle_window_change(const std::string& window_title)
{
    ...
    std::cout << "Window has changed to: " << window_title << " after: " << active_window << " for " << duration <<
        "seconds" << std::endl;
    ...
    static auto P = HyprlandAPI::registerCallbackDynamic(
        ...
        [&](void* self, SCallbackInfo& info, std::any data)
        {
            try
            {
                ...
                // }
                std::cout << "active window: " << title << std::endl;
